...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/empressninti)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/empressninti
```

A live public deployment of this template is available at [https://empressninti.templates.workers.dev](https://empressninti.templates.workers.dev)
